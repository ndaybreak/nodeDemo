angular.module("dialogs.controllers", ["ui.bootstrap.modal", "pascalprecht.translate"]).config(["$translateProvider",
    function (a) {
        a.translations("en-US", {
            ...
            DIALOGS_YES: "Yes",
            DIALOGS_NO: "No"
        }), a.preferredLanguage("en-US")
    }
]).controller("errorDialogCtrl", ["$scope", "$modalInstance", "$translate", "header", "msg",
    function (a, n, e, s, l) {
        a.header = angular.isDefined(s) ? s : e.instant("DIALOGS_ERROR"), a.msg = angular.isDefined(l) ? l : e.instant("DIALOGS_ERROR_MSG"), a.close = function () {
            n.close(), a.$destroy()
        }
    }
]).controller("waitDialogCtrl", ["$scope", "$modalInstance", "$translate", "$timeout", "header", "msg", "progress",
    function (a, n, e, s, l, o, t) {
        a.header = angular.isDefined(l) ? l : e.instant("DIALOGS_PLEASE_WAIT_ELIPS"), a.msg = angular.isDefined(o) ? o : e.instant("DIALOGS_PLEASE_WAIT_MSG"), a.progress = angular.isDefined(t) ? t : 100, a.$on("dialogs.wait.complete", function () {
            s(function () {
                n.close(), a.$destroy()
            })
...
]).controller("notifyDialogCtrl", ["$scope", "$modalInstance", "$translate", "header", "msg",
    function (a, n, e, s, l) {
        a.header = angular.isDefined(s) ? s : e.instant("DIALOGS_NOTIFICATION"), a.msg = angular.isDefined(l) ? l : e.instant("DIALOGS_NOTIFICATION_MSG"), a.close = function () {
            n.close(), a.$destroy()
        }
    }
]).controller("confirmDialogCtrl", ["$scope", "$modalInstance", "$translate", "header", "msg",
    function (a, n, e, s, l) {
        a.header = angular.isDefined(s) ? s : e.instant("DIALOGS_CONFIRMATION"), a.msg = angular.isDefined(l) ? l : e.instant("DIALOGS_CONFIRMATION_MSG"), a.no = function () {
            n.dismiss("no")
        }, a.yes = function () {
            n.close("yes")
        }
    }
]), angular.module("dialogs.services", ["ui.bootstrap.modal", "dialogs.controllers"]).provider("dialogs", [
    function () {
        var a = !0,
            n = !0,
            e = "dialogs-default",
        ...
        this.useBackdrop = function (n) {
            ...
            angular.isDefined(a) && (l = a)
        }, this.setSize = function (a) {
            angular.isDefined(a) && (o = angular.equals(a, "sm") || angular.equals(a, "lg") ? a : o)
        }, this.$get = ["$modal",
            function (l) {
                return {
                    error: function (s, t, r) {
                        return r = angular.isDefined(r) && (angular.equals(r, "sm") || angular.equals(r, "lg")) ? r : o, l.open({
                    ...
                    wait: function (s, t, r, i) {
                        return i = angular.isDefined(i) && (angular.equals(i, "sm") || angular.equals(i, "lg")) ? i : o, l.open({
                    ...
                    create: function (t, r, i, u) {
                        return u = angular.isDefined(u) && (angular.equals(u, "sm") || angular.equals(u, "lg")) ? u : o, l.open({
                            templateUrl: t,
                            controller: r,
                            keyboard: n,
                            backdrop: a,
