( function (  window, undefined ) {
	...
	var
		...
		Aui.fn = {
			...
			// 获取CSS样式
			// =================================================>
			// @mothed : Aui.fn.getStyle( DOM对象, CSS属性 )
			// @return : String
			...
			// 获取指定class元素
			// =================================================>
			// @mothed : Aui.fn.getByClass( 父级, class名, 标签名 )
			// @return : Array
		...
		// 对象字符串处理成url字符串
		// =================================================>
		// @mothed : Aui.makeString( 对象 或 字符串 )
		// @return : string
		...
		// AJAX请求
		// =================================================>
		// @mothed : Aui.ajax( { 路径, 发送数据, 编码, 类型, 发送前, 错误, 成功 } )
		// @return : false
